...
export default function Header() {
  return (
    <div className="header">
      <nav className="relative w-full flex flex-wrap items-center justify-between py-1 bg-purple-600 text-gray-200 shadow-lg navbar navbar-expand-lg navbar-light">
          ...
          <div className="flex items-center relative">
            <div className="dropdown relative">
              ...
              >
                ...
                <span className="text-white bg-red-700 absolute rounded-full text-xs mt-2 ml-3 py-0 px-1">
                  1
                </span>
              </button>
